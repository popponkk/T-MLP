"""Aggregate completed shared-linear ablations across seeds."""
...
VARIANTS = [
    ("ggpl_dynonly_ablation_shared_linear", "shared-linear / graph / channel"),
    ("ggpl_dynonly_ablation_shared_linear_no_channel", "shared-linear / graph / no-channel"),
    ("ggpl_dynonly_ablation_shared_linear_no_graph", "shared-linear / no-graph / channel"),
    ("ggpl_dynonly_ablation_shared_linear_no_graph_no_channel", "shared-linear / no-graph / no-channel"),
]
DATASETS = {
...
def main():
    ...
    parser.add_argument("--output-dir", default="results/dynonly_shared_linear_summary")
    ...
    if not per_seed:
        raise FileNotFoundError("No completed shared-linear ablation results were found")
