...
MODEL_CARDS = {
    ...
    'ggpl_dynonly_ablation': GGPLDynOnlyAblation,
    'ggpl_dynonly_ablation_no_channel': GGPLDynOnlyAblationNoChannel,
    'ggpl_dynonly_ablation_linear_tokenizer': GGPLDynOnlyAblationLinearTokenizer,
    'ggpl_dynonly_ablation_no_graph': GGPLDynOnlyAblationNoGraph,
    'ggpl_dynonly_ablation_linear_tokenizer_no_channel': GGPLDynOnlyAblationLinearTokenizerNoChannel,
    'ggpl_dynonly_ablation_no_graph_no_channel': GGPLDynOnlyAblationNoGraphNoChannel,
    'ggpl_dynonly_ablation_linear_tokenizer_no_graph': GGPLDynOnlyAblationLinearTokenizerNoGraph,
    'ggpl_dynonly_ablation_linear_tokenizer_no_graph_no_channel': GGPLDynOnlyAblationLinearTokenizerNoGraphNoChannel,
    'ggpl_dynonly_ablation_shared_linear': GGPLDynOnlyAblationSharedLinear,
    'ggpl_dynonly_ablation_shared_linear_no_channel': GGPLDynOnlyAblationSharedLinearNoChannel,
    'ggpl_dynonly_ablation_shared_linear_no_graph': GGPLDynOnlyAblationSharedLinearNoGraph,
    'ggpl_dynonly_ablation_shared_linear_no_graph_no_channel': GGPLDynOnlyAblationSharedLinearNoGraphNoChannel,
    'ggpl_dynonly_ablation_independent_nnlinear': GGPLDynOnlyAblationIndependentNNLinear,
    'ggpl_dynonly_ablation_independent_nnlinear_no_channel': GGPLDynOnlyAblationIndependentNNLinearNoChannel,
    'ggpl_dynonly_ablation_independent_nnlinear_no_graph': GGPLDynOnlyAblationIndependentNNLinearNoGraph,
    'ggpl_dynonly_ablation_independent_nnlinear_no_graph_no_channel': GGPLDynOnlyAblationIndependentNNLinearNoGraphNoChannel,
    ...
    'ggpl_tmlp_graph_slimtok_staticmask': GGPLTMLPGraphSlimTokStaticMask,
    'ggpl_tmlp_graph_slimtok_static_only': GGPLTMLPGraphSlimTokStaticOnly,
    'ggpl_tmlp_graph_slimtok_dynamic_only': GGPLTMLPGraphSlimTokDynamicOnly,
    'ggpl_tmlp_graph_slimtok_fixed_alpha': GGPLTMLPGraphSlimTokFixedAlpha,
    'ggpl_tmlp_graph_slimtok_identity_static': GGPLTMLPGraphSlimTokIdentityStatic,
